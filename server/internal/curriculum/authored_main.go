...
var mainBuilding = []Curriculum{
	...
	// ── 7F 일반 외과 병동 ───────────────────────────────────────────────
	{
		...
		Steps: []Step{
			...
			{Kind: "dlg", Name: "장음 청진 이유 설명", ScenarioID: "SCN-SURGWARD-00521"},
			{Kind: "quiz", Name: "조기 보행 격려", ScenarioID: "QZ-SURGWARD-00107"},
			{Kind: "dlg", Name: "수술 후 첫 통증 점수 평가", ScenarioID: "SCN-SURGWARD-00124"},
			{Kind: "boss", Name: "드레싱 삼출 경계 표시", ScenarioID: "SCN-SURGWARD-00131"},
		},
	},
	{
		...
		Building: "본관", Floor: "7F", Where: "본관 7F 일반 외과 병동",
		Steps: []Step{
			{Kind: "dlg", Name: "PCA 버튼 첫 사용 교육", ScenarioID: "SCN-SURGWARD-00143"},
			{Kind: "dlg", Name: "조기 보행 필요성 설명", ScenarioID: "SCN-SURGWARD-00186"},
			{Kind: "dlg", Name: "JP 배액관 비우기와 기록", ScenarioID: "SCN-SURGWARD-00479"},
			{Kind: "boss", Name: "보호자 가정 드레싱 교육", ScenarioID: "SCN-SURGWARD-00451"},
		},
	},
	{
		...
		Building: "본관", Floor: "7F", Where: "본관 7F 일반 외과 병동",
		Steps: []Step{
			{Kind: "event", Name: "CAM 양성 새 혼동 보고", ScenarioID: "SCN-SURGWARD-00717"},
			{Kind: "event", Name: "피로 흠뻑 젖은 복부 드레싱", ScenarioID: "SCN-SURGWARD-00359"},
			{Kind: "boss", Name: "고유량 산소 환자 중환자실 인계", ScenarioID: "SCN-SURGWARD-00326"},
		},
	},
	...
	// ── 6F 정형외과 병동 ────────────────────────────────────────────────
	{
		...
		Steps: []Step{
			...
			{Kind: "dlg", Name: "병실 입원 시 낙상 위험 팔찌를 채우며 설명하기 · Walter Adams", ScenarioID: "SCN-ORTHOWARD-00101"},
			{Kind: "quiz", Name: "보행 보조기구 훈련", ScenarioID: "QZ-ORTHOWARD-00113"},
			{Kind: "dlg", Name: "침상 난간을 올려 두겠다고 환자에게 알리기 · Norma Abbott", ScenarioID: "SCN-ORTHOWARD-00102"},
			{Kind: "boss", Name: "투약 전 이름과 생년월일로 환자 확인하기 · Gerald Acosta", ScenarioID: "SCN-ORTHOWARD-00103"},
		},
	},
	{
		...
		Building: "본관", Floor: "6F", Where: "본관 6F 정형외과 병동",
		Steps: []Step{
			{Kind: "dlg", Name: "발가락 색과 감각을 확인하는 신경혈관 사정 설명하기 · Dennis Alvarez", ScenarioID: "SCN-ORTHOWARD-00105"},
			{Kind: "dlg", Name: "진통제 투약 후 낙상 위험이 커졌음을 환자와 보호자에게 설명하기 · Sharon Armstrong", ScenarioID: "SCN-ORTHOWARD-00108"},
			{Kind: "dlg", Name: "검사실 이송 전 신원과 목적지 확인하기 · Beatrice Anderson", ScenarioID: "SCN-ORTHOWARD-00106"},
			{Kind: "boss", Name: "호출벨 위치를 알려주고 도움 요청 방법 안내하기 · Lorraine Allen", ScenarioID: "SCN-ORTHOWARD-00104"},
		},
	},
	{
		...
		Building: "본관", Floor: "6F", Where: "본관 6F 정형외과 병동",
		Steps: []Step{
			{Kind: "dlg", Name: "수혈 시작 전 두 명이 함께 혈액을 대조 확인하기 · Marcus Arnold", ScenarioID: "SCN-ORTHOWARD-00109"},
			{Kind: "event", Name: "수술 후 첫 기상 시 어지럼을 확인하고 천천히 일어나도록 돕기 · Raymond Andrews", ScenarioID: "SCN-ORTHOWARD-00107"},
			{Kind: "boss", Name: "야간 화장실 이동 시 반드시 벨을 누르도록 약속받기 · Estelle Atkins", ScenarioID: "SCN-ORTHOWARD-00110"},
		},
	},
	...
	// ── 2F 피부과 센터 ──────────────────────────────────────────────────
	{
		...
		Steps: []Step{
			...
			{Kind: "dlg", Name: "시술 전 환자 이름과 생년월일 확인 · Larry Burns", ScenarioID: "SCN-DERM-00101"},
			{Kind: "quiz", Name: "광선치료 전 안내", ScenarioID: "QZ-DERM-00110"},
			{Kind: "dlg", Name: "국소 도포약 이름과 부위 확인 · Jeffrey Curtis", ScenarioID: "SCN-DERM-00102"},
			{Kind: "boss", Name: "리도카인 총량 계산 확인 · Shirley Abbott", ScenarioID: "SCN-DERM-00109"},
		},
	},
	{
		...
		Building: "본관", Floor: "2F", Where: "본관 2F 피부과 센터",
		Steps: []Step{
			{Kind: "dlg", Name: "냉동치료 전 치료 부위 표시 확인 · Brenda Albright", ScenarioID: "SCN-DERM-00104"},
			{Kind: "dlg", Name: "시술 동의서 서명 여부 확인 · Angela Archer", ScenarioID: "SCN-DERM-00106"},
			{Kind: "dlg", Name: "광선치료 용량 상향 전 지난 반응 확인 · Edward Bennett", ScenarioID: "SCN-DERM-00107"},
			{Kind: "boss", Name: "국소 마취제 알레르기 재확인 · Cynthia Arnett", ScenarioID: "SCN-DERM-00105"},
		},
	},
	{
		...
		Building: "본관", Floor: "2F", Where: "본관 2F 피부과 센터",
		Steps: []Step{
			{Kind: "dlg", Name: "광선치료 전 보호안경 착용 확인 · Diane Bailey", ScenarioID: "SCN-DERM-00103"},
			{Kind: "dlg", Name: "여러 병변 중 치료 부위 혼동 방지 · Rachel Chandler", ScenarioID: "SCN-DERM-00108"},
			{Kind: "boss", Name: "조직검사 좌우 부위 재확인 · Michael Anderson", ScenarioID: "SCN-DERM-00110"},
		},
	},
}
