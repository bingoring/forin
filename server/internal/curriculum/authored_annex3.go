...
var annex3 = []Curriculum{
	// ── 1F 영상의학과 ───────────────────────────────────────────────────
	{
		...
		Steps: []Step{
			...
			{Kind: "dlg", Name: "폐경이라 필요 없다는 환자에게도 임신 여부 확인 절차를 규정대로 지키기 · Cynthia Armstrong", ScenarioID: "SCN-RAD-00104"},
			{Kind: "quiz", Name: "MRI 반입 금지 확인", ScenarioID: "QZ-RAD-00002"},
			{Kind: "dlg", Name: "무릎이라고만 적힌 요청서를 두고 좌우를 헷갈려하는 환자에게 되묻기 · Stephen Calvert", ScenarioID: "SCN-RAD-00107"},
			{Kind: "boss", Name: "요청서의 좌우 표기를 환자 자신의 말로 다시 확인하기 · Justin Briggs", ScenarioID: "SCN-RAD-00102"},
		},
	},
	{
		...
		Building: "별관 3", Floor: "1F", Where: "별관 3 1F 영상의학과",
		Steps: []Step{
			{Kind: "dlg", Name: "환자 몸에 붙은 표시 마커가 요청서 부위와 일치하는지 맞춰 보기 · Brian Conley", ScenarioID: "SCN-RAD-00105"},
			{Kind: "dlg", Name: "접수대에서 이름과 생년월일 두 지표로 환자 신원을 확인하기 · Samantha Bass", ScenarioID: "SCN-RAD-00101"},
			{Kind: "dlg", Name: "성과 생년월일이 비슷한 두 환자가 뒤섞일 뻔한 것을 접수 단계에서 발견하기 · Michael Carter", ScenarioID: "SCN-RAD-00108"},
			{Kind: "boss", Name: "대기실에 이름이 비슷한 환자가 함께 있어 호출 전 한 번 더 되묻기 · Katherine Allen", ScenarioID: "SCN-RAD-00103"},
		},
	},
	{
		...
		Building: "별관 3", Floor: "1F", Where: "별관 3 1F 영상의학과",
		Steps: []Step{
			{Kind: "dlg", Name: "X-ray 촬영 전 환자의 열쇠와 벨트 등 금속 소지품을 제거시키기 · Donna Bowman", ScenarioID: "SCN-RAD-00106"},
			{Kind: "dlg", Name: "요청서 진단명과 환자가 호소하는 통증 부위가 달라 의뢰의에게 되묻기 · Gregory Ashford", ScenarioID: "SCN-RAD-00110"},
			{Kind: "boss", Name: "병동에서 올라온 환자의 손목밴드가 훼손돼 신원 확인 수단이 부족해지기 · Stephanie Castillo", ScenarioID: "SCN-RAD-00109"},
		},
	},
	...
	// ── 2F 특수 외래 ────────────────────────────────────────────────────
	{
		...
		Steps: []Step{
			...
			{Kind: "dlg", Name: "동명이인 환자 두 명이 같은 시간에 접수한 상황 구분하기 · Karen Ayala", ScenarioID: "SCN-SPECIALTY-00107"},
			{Kind: "quiz", Name: "안과·이비인후과 용어", ScenarioID: "QZ-SPECIALTY-00001"},
			{Kind: "dlg", Name: "약물 알레르기가 있는지 팔찌를 보며 다시 묻기 · Sharon Boyle", ScenarioID: "SCN-SPECIALTY-00104"},
			{Kind: "boss", Name: "점안약을 넣기 전에 오른쪽 눈인지 왼쪽 눈인지 확인하기 · Nancy Ambrose", ScenarioID: "SCN-SPECIALTY-00102"},
		},
	},
	{
		...
		Building: "별관 3", Floor: "2F", Where: "별관 3 2F 특수 외래",
		Steps: []Step{
			{Kind: "dlg", Name: "채혈 직전에 환자 팔찌와 검체 라벨을 대조하기 · Bruce Barajas", ScenarioID: "SCN-SPECIALTY-00103"},
			{Kind: "dlg", Name: "조영제 검사 전에 신장 수치와 조영제 알레르기를 교차 확인하기 · Judy Barron", ScenarioID: "SCN-SPECIALTY-00109"},
			{Kind: "dlg", Name: "약을 주기 전에 약 이름과 용량을 소리 내어 확인하기 · Diane Bledsoe", ScenarioID: "SCN-SPECIALTY-00106"},
			{Kind: "boss", Name: "외래 접수대에서 이름과 생년월일로 환자 확인하기 · Donald Abbott", ScenarioID: "SCN-SPECIALTY-00101"},
		},
	},
	{
		...
		Building: "별관 3", Floor: "2F", Where: "별관 3 2F 특수 외래",
		Steps: []Step{
			{Kind: "dlg", Name: "인슐린 처방 용량이 평소와 달라 처방을 다시 확인하기 · Ricardo Chandler", ScenarioID: "SCN-SPECIALTY-00110"},
			{Kind: "dlg", Name: "관절강 주사 전에 시술 부위 표시와 동의서를 함께 재확인하기 · Frank Caldwell", ScenarioID: "SCN-SPECIALTY-00108"},
			{Kind: "boss", Name: "시술 전에 금식을 지켰는지 구두로 확인하기 · Carl Cortez", ScenarioID: "SCN-SPECIALTY-00105"},
		},
	},
