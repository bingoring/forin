...
const styles = StyleSheet.create({
  ...
  headerText: { fontFamily: fonts.heading, fontSize: fs(10.5), color: colors.ink },
  ...
  no: { fontFamily: fonts.heading, fontSize: fs(10), color: colors.text, width: 26 },
  track: { flex: 1, height: 9, backgroundColor: '#fff', borderWidth: 2, borderColor: colors.ink },
  fill: { position: 'absolute', left: 0, top: 0, bottom: 0 },
  score: { fontFamily: fonts.heading, fontSize: fs(11), color: colors.ink, width: 22, textAlign: 'right' },
});
