...
//      right/bottom) is what actually puts ink beside the card. Left as a
//      separate observation rather than changed here: PixelBox is used across
//      the whole app and is not this task's scope.
