...
import { QuizShell, Shadowed, C } from '@/components/quiz/QuizShell';
import { PixelButton } from '@/components/PixelButton';

export function McqQuiz({ quiz, onExit, onComplete }: { quiz: QuizDetail; onExit: () => void; onComplete: () => void }) {
  ...
  return (
    ...
    >
      ...
      <View style={{ backgroundColor: C, borderWidth: 3, borderColor: C, padding: 12, marginBottom: 13, position: 'relative' }}>
        ...
        <Text style={{ fontFamily: fonts.body, fontSize: 12.5, color: colors.cream, lineHeight: 19 }}>{c.scene}</Text>
      </View>
