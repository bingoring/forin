  ...
  return (
    ...
    >
          ...
          <View style={{ backgroundColor: '#fff', borderWidth: 3, borderColor: C, padding: 12 }}>
            {(c.given ?? []).map((g, i) => (
              <View key={i} style={{ flexDirection: 'row', justifyContent: 'space-between', paddingVertical: 3, borderBottomWidth: 1, borderBottomColor: '#2A252233', borderStyle: 'dotted' }}>
                <Text style={{ fontFamily: fonts.body, fontSize: fs(12), color: C }}>{g.label}</Text>
                <Text style={{ fontFamily: fonts.heading, fontSize: fs(12), color: C }}>{g.value}</Text>
              </View>
            ))}
            <View style={{ marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, flexWrap: 'wrap' }}>
              <Text style={{ fontFamily: fonts.heading, fontSize: fs(15), color: C }}>{c.eq} =</Text>
              <View style={{ backgroundColor: entry ? colors.mint : colors.yellow + '44', borderWidth: 2.5, borderColor: C, paddingVertical: 3, paddingHorizontal: 14, minWidth: 60, alignItems: 'center' }}>
                <Text style={{ fontFamily: fonts.heading, fontSize: fs(15), color: C }}>{entry || '?'}</Text>
              </View>
              <Text style={{ fontFamily: fonts.body, fontSize: fs(11), color: colors.textSoft }}>{c.answerUnit}</Text>
            </View>
          </View>
        </Shadowed>
      )}
      ...
      <View style={{ marginTop: 14 }}>
        <Text style={{ fontFamily: fonts.heading, fontSize: fs(10), color: colors.textSoft, marginBottom: 6 }}>━ 계산기 ━━━━━━━━</Text>
          ...
          {KEYS.map((k) => (
            <Shadowed key={k} offset={2} style={{ width: '31.5%' }}>
              <Pressable onPress={() => press(k)} style={{ backgroundColor: k === '⌫' ? colors.paper : '#fff', borderWidth: 2.5, borderColor: C, paddingVertical: 10, alignItems: 'center' }}>
                <Text style={{ fontFamily: fonts.heading, fontSize: fs(15), color: C }}>{k}</Text>
              </Pressable>
            </Shadowed>
          ))}
        </View>
        ...
        <Shadowed offset={3}>
          <View style={{ backgroundColor: '#fff', borderWidth: 3, borderColor: C, marginBottom: 10 }}>
            <View style={{ backgroundColor: colors.yellow, borderBottomWidth: 2.5, borderBottomColor: C, paddingVertical: 4, paddingHorizontal: 8, flexDirection: 'row', justifyContent: 'space-between' }}>
              <Text style={{ fontFamily: fonts.heading, fontSize: fs(10), color: C }}>ORDER · {o.id}</Text>
              <Text style={{ fontFamily: fonts.heading, fontSize: fs(9), color: C }}>{o.prescriber} · {o.time}</Text>
            </View>
            <View style={{ paddingVertical: 8, paddingHorizontal: 10 }}>
              {!!o.patient && <Text style={{ fontFamily: fonts.body, fontSize: fs(12), color: C }}><Text style={{ fontFamily: fonts.heading }}>Patient: </Text>{o.patient}</Text>}
              {!!o.drug && <Text style={{ fontFamily: fonts.body, fontSize: fs(12), color: C, marginTop: 3 }}><Text style={{ backgroundColor: colors.yellow, fontFamily: fonts.heading }}> {o.drug} </Text></Text>}
            </View>
          </View>
        </Shadowed>
      )}
      ...
      <View style={{ flexDirection: 'row', gap: 10, alignItems: 'flex-start' }}>
          ...
          <Shadowed offset={3} style={{ width: 100 }}>
            <View style={{ backgroundColor: colors.paper, borderWidth: 2.5, borderColor: C, padding: 6, paddingTop: 10 }}>
              <View style={{ position: 'absolute', top: -7, left: 4, backgroundColor: '#fff', borderWidth: 1.5, borderColor: C, paddingHorizontal: 4 }}>
                <Text style={{ fontFamily: fonts.heading, fontSize: fs(8), color: C }}>ON HAND</Text>
              </View>
              <VialArt />
              <Text style={{ fontFamily: fonts.heading, fontSize: fs(10), color: C, textAlign: 'center', marginTop: 4 }}>{v.drug}</Text>
              <Text style={{ fontFamily: fonts.heading, fontSize: fs(12), color: '#DC2626', textAlign: 'center', marginTop: 2 }}>{v.concentration}</Text>
              {!!v.size && <Text style={{ fontFamily: fonts.body, fontSize: fs(9), color: colors.textSoft, textAlign: 'center', marginTop: 1 }}>{v.size}</Text>}
            </View>
          </Shadowed>
        )}
        ...
        <Shadowed offset={3} style={{ flex: 1 }}>
          <View style={{ backgroundColor: '#fff', borderWidth: 2.5, borderColor: C, paddingVertical: 8, paddingHorizontal: 10 }}>
            <Text style={{ fontFamily: fonts.heading, fontSize: fs(9), color: colors.textSoft, marginBottom: 6 }}>━ FORMULA ━</Text>
            {/* D/H × Q = ? */}
            <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6 }}>
              <Fraction top="D" bottom="H" />
              <Text style={{ fontFamily: fonts.heading, fontSize: fs(14), color: C }}>× Q =</Text>
              <View style={{ backgroundColor: entry ? colors.mint : colors.yellow + '55', borderWidth: 2, borderColor: C, paddingVertical: 2, paddingHorizontal: 10, minWidth: 44, alignItems: 'center' }}>
                <Text style={{ fontFamily: fonts.heading, fontSize: fs(14), color: C }}>{entry || '?'}</Text>
              </View>
            </View>
            ...
            {checked && (
              <View style={{ marginTop: 10, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 5, flexWrap: 'wrap' }}>
                ...
                <Text style={{ fontFamily: fonts.heading, fontSize: fs(13), color: C }}>× {c.perQty} =</Text>
                <View style={{ backgroundColor: correct ? colors.yellow : '#FEE2E2', borderWidth: 2, borderColor: C, paddingVertical: 3, paddingHorizontal: 8 }}>
                  <Text style={{ fontFamily: fonts.heading, fontSize: fs(14), color: C }}>{c.answer} {c.answerUnit}</Text>
                </View>
              </View>
            )}
            <View style={{ marginTop: 8, paddingTop: 8, borderTopWidth: 1.5, borderTopColor: '#2A252233', borderStyle: 'dashed' }}>
              <Text style={{ fontFamily: fonts.body, fontSize: fs(9), color: colors.textSoft, lineHeight: 13 }}>
        ...
        <Shadowed offset={3} style={{ marginTop: 10 }}>
          <View style={{ backgroundColor: '#fff', borderWidth: 2.5, borderColor: C, paddingVertical: 8, paddingHorizontal: 10 }}>
            <View style={{ flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', marginBottom: 8 }}>
              <Text style={{ fontFamily: fonts.heading, fontSize: fs(10), color: C }}>주사기 눈금 ({syringeMax} mL)</Text>
              <View style={{ backgroundColor: colors.mint, borderWidth: 1.5, borderColor: C, paddingHorizontal: 5, paddingVertical: 1 }}>
                <Text style={{ fontFamily: fonts.heading, fontSize: fs(11), color: C }}>{c.answer} {c.answerUnit}</Text>
              </View>
            </View>
      ...
      <Shadowed offset={2} style={{ marginTop: 10 }}>
        <View style={{ backgroundColor: '#FEF3C7', borderWidth: 2, borderColor: C, paddingVertical: 7, paddingHorizontal: 9, flexDirection: 'row', gap: 6 }}>
          <View style={{ backgroundColor: '#F59E0B', borderWidth: 1.5, borderColor: C, paddingHorizontal: 5, alignSelf: 'flex-start' }}>
            <Text style={{ fontFamily: fonts.heading, fontSize: fs(9), color: '#fff' }}>5R</Text>
          </View>
  ...
  return (
    <View style={{ flexDirection: 'row', alignItems: 'center', gap: 2 }}>
      <View style={{ alignItems: 'center' }}>
        <Text style={{ fontFamily: fonts.heading, fontSize: fs(13), color: col, paddingHorizontal: 3 }}>{top}</Text>
        <View style={{ height: 2, backgroundColor: C, alignSelf: 'stretch' }} />
        <Text style={{ fontFamily: fonts.heading, fontSize: fs(13), color: col, paddingHorizontal: 3 }}>{bottom}</Text>
      </View>
      {!!sub && <Text style={{ fontFamily: fonts.body, fontSize: fs(9), color: colors.textSoft }}>{sub}</Text>}
    </View>
  );
}
  ...
  return (
    <View style={{ height: 30, justifyContent: 'center' }}>
      ...
      <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 6, marginTop: 2 }}>
        <Text style={{ fontFamily: fonts.heading, fontSize: fs(8), color: colors.textSoft }}>0</Text>
        <Text style={{ fontFamily: fonts.heading, fontSize: fs(8), color: C }}>{label}</Text>
        <Text style={{ fontFamily: fonts.heading, fontSize: fs(8), color: colors.textSoft }}>MAX</Text>
      </View>
    </View>
  );
}
