...
export default function RootLayout() {
  ...
  useEffect(() => {
    ...
    Promise.all([bootstrapSession(), hydrateEconomy(() => api.economyConfig()), loadSfxPreference(), loadLocale(), loadAvatar(), loadDialogueLayout(), loadDailyBrief(), loadGameScores()])
