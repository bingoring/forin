...
export const WARD_INTERIOR: Interior = {
  ...
  collision: [
    ...
    // room4 | lower divider (y35) — thresholds x6-7(→1인실) / x19-20(→격리)
    { x: 1, y: 35, w: 5, h: 1 }, { x: 8, y: 35, w: 11, h: 1 }, { x: 21, y: 35, w: 6, h: 1 },
  ...
  objects: [
    ...
    { id: 'th-priv', type: 'threshold', x: 6, y: 35, props: { w: 2, h: 1, label: '→ 1인실' } },
    { id: 'th-iso', type: 'threshold', x: 19, y: 35, props: { w: 2, h: 1, label: '→ 격리' } },
    ...
    // ════════ 1인실 (private, y36-50) ════════
    { id: 'bl-priv', type: 'baylabel', x: 1, y: 36, props: { text: '1인실 · PRIVATE' } },
    { id: 'o-p-bed', type: 'ibed', x: 3, y: 38, props: { variant: 'ward', occupied: true } },
    { id: 'o-p-mon', type: 'imonitor', x: 2, y: 38, props: { beep: true } },
    { id: 'o-p-iv', type: 'iiv', x: 6, y: 38 },
    { id: 'o-p-tv', type: 'walltv', x: 2, y: 43, props: { w: 2 } },
    { id: 'o-p-chair', type: 'ichair', x: 8, y: 40, props: { color: '#FED7AA', facing: 'left' } },
    { id: 'o-p-sofa', type: 'sofa', x: 8, y: 45, props: { w: 3, h: 2, color: '#9CB4C8' } },
    { id: 'o-p-plant', type: 'iplant', x: 11, y: 49 },

    // ════════ VRE 접촉 격리실 (iso, y36-50) ════════
    { id: 'bl-iso', type: 'baylabel', x: 14, y: 36, props: { text: 'VRE 접촉 격리실', highlight: true } },
    { id: 'o-i-sign', type: 'isosign', x: 19, y: 35 },
    { id: 'o-i-cart', type: 'isolationcart', x: 15, y: 37, props: { w: 2, h: 2 } },
    { id: 'o-i-bed', type: 'ibed', x: 22, y: 38, props: { variant: 'ward', occupied: true } },
    { id: 'o-i-mon', type: 'imonitor', x: 26, y: 38 },
    { id: 'o-i-tv', type: 'walltv', x: 24, y: 36, props: { w: 2 } },
    { id: 'o-i-bp', type: 'dedicatedbp', x: 22, y: 42, props: { w: 1, h: 2 } },
    { id: 'o-i-waste', type: 'wastebin', x: 20, y: 43, props: { tone: 'infectious' } },
  ],
  hotspots: [
    ...
    { id: 'hs-immuno', kind: 'info', x: 4, y: 38, label: '면역저하 케어' },
    { id: 'hs-gown', kind: 'quest', x: 15, y: 37, label: '가운·장갑 착용' },
    { id: 'hs-dedic', kind: 'info', x: 22, y: 38, label: '전용 의료기기' },
  ],
  npcs: [
    ...
    { id: 'wd-r-d', kind: 'doctor', mode: 'idle', seed: 508, start: { x: 3, y: 27 } },
    { id: 'wd-p-p', kind: 'parent', mode: 'idle', seed: 509, start: { x: 9, y: 41 } },
    { id: 'wd-p-n', kind: 'nurse', mode: 'idle', seed: 510, start: { x: 5, y: 42 } },
    { id: 'wd-i-n', kind: 'nurse', mode: 'idle', seed: 511, start: { x: 17, y: 39 } },
  ],
};
