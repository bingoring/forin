...
export const ER_INTERIOR: Interior = {
  ...
  npcs: [
    ...
    { id: 'er-amb-p2', kind: 'paramedic', mode: 'idle', seed: 42, start: { x: 7, y: 7 }, marker: 'quest', markerLabel: '뇌졸중 의심 신속 사정', scenarioId: 'SCN-ER-00009' },
    { id: 'er-sec-1', kind: 'police', mode: 'idle', seed: 43, start: { x: 16, y: 4 }, marker: 'urgent', markerLabel: '경찰 인계', scenarioId: 'SCN-ER-00005' },
    { id: 'er-sec-2', kind: 'police', mode: 'idle', seed: 44, start: { x: 24, y: 4 }, marker: 'quest', markerLabel: '두부 외상 사정', scenarioId: 'SCN-ER-00010' },
    { id: 'er-reg-n1', kind: 'nurse', mode: 'idle', seed: 45, start: { x: 30, y: 6 }, marker: 'quest', markerLabel: '약물 과다복용 응급', scenarioId: 'SCN-ER-00011' },
    { id: 'er-reg-n2', kind: 'nurse', mode: 'idle', seed: 46, start: { x: 32, y: 6 }, marker: 'quest', markerLabel: '알콜 금단 사정', scenarioId: 'SCN-ER-00012' },
    { id: 'er-reg-pat', kind: 'patient', mode: 'idle', seed: 47, start: { x: 30, y: 8 }, marker: 'quest', markerLabel: '화상 응급 처치', scenarioId: 'SCN-ER-00013' },
    { id: 'er-reg-vis', kind: 'visitor', mode: 'idle', seed: 48, start: { x: 33, y: 8 }, marker: 'quest', markerLabel: '흉부 외상 사정', scenarioId: 'SCN-ER-00014' },
    { id: 'er-tri-n', kind: 'nurse', mode: 'idle', seed: 49, start: { x: 4, y: 10 }, marker: 'quest', markerLabel: '소아 이물 흡인', scenarioId: 'SCN-ER-00015' },
