...
export const PEDS_INTERIOR: Interior = {
  ...
  npcs: [
    // welcome
    { id: 'pd-w-n1', kind: 'nurse', mode: 'idle', seed: 301, start: { x: 14, y: 6 } },
    { id: 'pd-w-n2', kind: 'nurse', mode: 'idle', seed: 302, start: { x: 16, y: 6 } },
    { id: 'pd-w-n3', kind: 'nurse', mode: 'idle', seed: 303, start: { x: 3, y: 8 } },
    { id: 'pd-w-c1', kind: 'child', mode: 'idle', seed: 304, start: { x: 25, y: 8 } },
    { id: 'pd-w-c2', kind: 'child', mode: 'idle', seed: 305, start: { x: 27, y: 8 } },
    { id: 'pd-w-p1', kind: 'parent', mode: 'idle', seed: 306, start: { x: 29, y: 9 } },
    { id: 'pd-w-p2', kind: 'parent', mode: 'idle', seed: 307, start: { x: 3, y: 11 } },
    { id: 'pd-w-c3', kind: 'child', mode: 'idle', seed: 308, start: { x: 5, y: 11 } },
    // exam
    { id: 'pd-e-d', kind: 'doctor', mode: 'idle', seed: 309, start: { x: 4, y: 24 } },
    { id: 'pd-e-c', kind: 'child', mode: 'idle', seed: 310, start: { x: 6, y: 25 } },
    { id: 'pd-e-p', kind: 'parent', mode: 'idle', seed: 311, start: { x: 7, y: 24 } },
    // ward
    { id: 'pd-wd-n1', kind: 'nurse', mode: 'idle', seed: 312, start: { x: 13, y: 20 } },
    { id: 'pd-wd-n2', kind: 'nurse', mode: 'idle', seed: 313, start: { x: 15, y: 20 } },
    { id: 'pd-wd-n3', kind: 'nurse', mode: 'idle', seed: 314, start: { x: 17, y: 20 } },
