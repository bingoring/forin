...
export const OR_INTERIOR: Interior = {
  ...
  hotspots: [
    ...
    { id: 'hs-lk', kind: 'quest', x: 24, y: 7, label: '수술복 착용', scenarioId: 'SCN-OR-00006' },
    { id: 'hs-po-id', kind: 'quest', x: 3, y: 17, label: '환자 확인 · ID', scenarioId: 'SCN-OR-00001' },
    { id: 'hs-po-anes', kind: 'quest', x: 3, y: 23, label: '마취 면담', scenarioId: 'SCN-OR-00007' },
    { id: 'hs-clean', kind: 'quest', x: 16, y: 18, label: '멸균 물품', scenarioId: 'SCN-OR-00008' },
    { id: 'hs-dirty', kind: 'quest', x: 16, y: 25, label: '기구 반출 → SPD', scenarioId: 'SCN-OR-00009' },
    { id: 'hs-pacu-ho', kind: 'quest', x: 22, y: 17, label: '인계 Hand-off', scenarioId: 'SCN-OR-00004' },
    { id: 'hs-pacu-care', kind: 'quest', x: 26, y: 17, label: '오한 케어 · O2', scenarioId: 'SCN-OR-00010' },
    { id: 'hs-pacu-desk', kind: 'quest', x: 31, y: 25, label: 'PACU 데스크', scenarioId: 'SCN-OR-00011' },
    { id: 'hs-or1-pass', kind: 'quest', x: 7, y: 37, label: '기구 패스', scenarioId: 'SCN-OR-00003' },
    { id: 'hs-or1-count', kind: 'quest', x: 13, y: 42, label: '카운트 (순회)', scenarioId: 'SCN-OR-00012' },
    { id: 'hs-scrub', kind: 'quest', x: 17, y: 35, label: '5분 스크럽', scenarioId: 'SCN-OR-00013' },
    { id: 'hs-or2-robot', kind: 'quest', x: 33, y: 43, label: '로봇 콘솔', scenarioId: 'SCN-OR-00002' },
    { id: 'hs-or2-lap', kind: 'quest', x: 29, y: 37, label: '복강경 화면', scenarioId: 'SCN-OR-00014' },
  ],
  npcs: [
    // family + locker
