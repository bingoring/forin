...
export const OR_INTERIOR: Interior = {
  ...
  hotspots: [
    { id: 'hs-fam', kind: 'info', x: 12, y: 6, label: '가족 대기', scenarioId: 'or-family-update' },
    { id: 'hs-lk', kind: 'info', x: 24, y: 7, label: '수술복 착용' },
    { id: 'hs-po-id', kind: 'quest', x: 3, y: 17, label: '환자 확인 · ID', scenarioId: 'or-garcia-consent' },
    ...
    { id: 'hs-pacu-ho', kind: 'quest', x: 22, y: 17, label: '인계 Hand-off', scenarioId: 'or-pacu-handoff' },
    { id: 'hs-pacu-care', kind: 'info', x: 26, y: 17, label: '오한 케어 · O2' },
    { id: 'hs-pacu-desk', kind: 'info', x: 31, y: 25, label: 'PACU 데스크' },
    { id: 'hs-or1-pass', kind: 'quest', x: 7, y: 37, label: '기구 패스', scenarioId: 'or-instrument-pass' },
    { id: 'hs-or1-count', kind: 'info', x: 13, y: 42, label: '카운트 (순회)' },
    { id: 'hs-scrub', kind: 'info', x: 17, y: 35, label: '5분 스크럽' },
    { id: 'hs-or2-robot', kind: 'quest', x: 33, y: 43, label: '로봇 콘솔', scenarioId: 'or-timeout' },
