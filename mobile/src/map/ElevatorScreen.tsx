...
export const ELEVATOR_BUILDINGS: Record<string, ElevBuilding> = {
  tower: {
    ...
    floors: [
      { f: '8F', depts: ['일반 내과 병동', '외과 병동', '정형외과 병동'], icon: '🛏', interior: 'INT-WARD-00001', entry: { x: 1, y: 15 } },
  ...
  women: {
    ...
    floors: [
      ...
      { f: '1F', depts: ['소아청소년과 외래', '산부인과 외래', '키즈 놀이광장'], icon: '🎈', lobby: true, sdepts: ['PEDS'], interior: 'INT-PEDS-00001', entry: { x: 16, y: 1 } },
    ],
  },
  onco: {
